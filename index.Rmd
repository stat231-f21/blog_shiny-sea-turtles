...
# create a table of cross products between actors by movie
final5 <- final4 %>%
  select(title, people) %>%
  table() %>%
  crossprod() 

# set diagonal cross products (each actor working with themself) equal to 0, and make a new data frame. 
diag(final5) <- 0
...
```
>>>>>>> eeda260d0ea8449f7c80358a19e38e19e5c184cc
