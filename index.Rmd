...
ggplotly(ggplot() +
  ...
  geom_sf(data = netflix_map_shows, aes(fill = Amount_of_Content, label = Country)) +
  scale_fill_viridis(option = "viridis", direction = -1) +
  theme_void() +
  labs(fill = "Amount of Content",
       title = "Countries Netflix Content Has Been Filmed In (From 2013 to 2019)") +
