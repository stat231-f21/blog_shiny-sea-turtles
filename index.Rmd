...
The table is notable in its ability to display large quantities of information in a streamlined manner. In order to achieve this, we created a data frame from the second [Kaggle dataset](https://www.kaggle.com/ruchi798/movies-on-netflix-prime-video-hulu-and-disney) (which included over 9000 observations) and selected the variables of interest “Year”, “Title”, “IMDb”, “RottenTomatoes”, and “Service”. The variables “Year”, “IMDb”, and “RottenTomatoes” were used for two-sided slider inputs, allowing the user to specify the ranges of each that they want to look at. The “Service” variable is not interactive, but gives information on the streaming platform or platforms that the title is found on. This can further be narrowed using the search bar at the top. 
